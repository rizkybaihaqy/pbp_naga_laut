...
class Penulis extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            'post' => $this->penulis->getAllPost($session->id),
            'penulis' => $this->penulis->getPenulis($session->id),
            'session' => \Config\Services::session(),
    ...
    public function editprofile()
    {
        ...
        if ($this->validate($validation_rules)) {
            $query = $this->penulis->editProfile($data, $session->id);
            if ($query) {
    ...
    public function editpwd()
    {
        ...
        $query_old = $this->penulis->cekPassword($password, $session->id);
        if ($query_old) {
            if ($this->validate($validation_rules)) {
                $query = $this->penulis->editPassword($data, $session->id);
                if ($query) {
